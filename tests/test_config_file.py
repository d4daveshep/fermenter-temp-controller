...
#     filename = "tests/test_valid_config_file.ini"
...
#
#     assert (
#         err_info.value.args[0] == "target_temp 'blah_blah' could not be read as a float"
#     )
#
#
...
#         == "'brew_id' not found in fermenter section in config file"
#     )
#
#
...
#     assert (
#         err_info.value.args[0]
#         == "invalid timezone 'blah_blah' in general section of config file"
#     )
#
#
...
#
#     assert (
#         err_info.value.args[0] == "'url' not found in influxdb section in config file"
#     )
#
#
...
#     assert (
#         err_info.value.args[0]
#         == "URL 'blah_blah' is not valid URL in influxdb section in config file"
#     )
#
#
...
#
#     assert (
#         err_info.value.args[0] == "'org' not found in influxdb section in config file"
#     )
#
#
...
#     assert (
#         err_info.value.args[0]
#         == "'bucket' not found in influxdb section in config file"
#     )
#
#
